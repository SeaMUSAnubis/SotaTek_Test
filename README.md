...
Detection_image.ipynb: Training Detectron2 cho bài toán nhận diện
OCR_note_table.ipynb: Training Donut OCR cho bài toán trích xuất văn bản
requirements.txt
README.md
```
...
```
*Thay đổi dir weight cho model Detectron2 tại `Weight/Detection/detection_weight.pth` và model OCR Donut tại `Weight/OCR`.
...
### Kết quả đạt được 
<img width="665" height="271" alt="image" src="https://github.com/user-attachments/assets/1b42ce22-3105-4576-9536-466ff3e33d59" />
